...
assert.match(indexSource, /id="meteoscope-lens-font-weight"/);
assert.match(indexSource, /id="meteoscope-lens-watermark-backdrop"/);
assert.match(indexSource, /id="meteoscope-lens-font-scale"[^>]*type="range"/);
...
assert.match(modalSource, /function normalizeImageHorizontalPosition/);
assert.match(modalSource, /function normalizeImageScale/);
assert.match(modalSource, /function getWatermarkSettings/);
assert.match(modalSource, /function syncWatermarkSettingsUi/);
assert.match(modalSource, /function setupImagePositionGesture/);
assert.match(modalSource, /function getImageLayout/);
assert.match(modalSource, /function setImagePositionFromFocus/);
assert.match(modalSource, /function setImagePositionFromOffsets/);
...
assert.match(modalSource, /Math\.min\(width \/ imageElement\.naturalWidth, height \/ imageElement\.naturalHeight\)/u);
