...
export const MAP_DATA_ENDPOINTS = {
  ...
  gsiReliefTiles: "https://cyberjapandata.gsi.go.jp/xyz/relief/{z}/{x}/{y}.png",
  gsiHillshadeTiles: "https://cyberjapandata.gsi.go.jp/xyz/hillshademap/{z}/{x}/{y}.png",
...
export const JMA_ENDPOINTS = {
  ...
  warningsMap: "https://www.jma.go.jp/bosai/warning/data/r8/map.json",
  ...
  riverFloodGeometry: publicAsset("data/jma-designated-river-geometry.geojson"),
  ...
  prefecturesMap: publicAsset("data/japan-prefectures-map.geojson"),
  ...
  tsunamiObservationStations: publicAsset("data/jma-tsunami-observation-stations.json"),
  tideStationCatalog: "https://www.jma.go.jp/bosai/tidelevel/const/tide_area.json",
  tideObservationTime: "https://www.jma.go.jp/bosai/tidelevel/data/tide/tide_time.json",
  tideObservationBase: "https://www.jma.go.jp/bosai/tidelevel/data/tide",
  tideAstronomicalBase: "https://www.jma.go.jp/bosai/tidelevel/const/tide_astro",
